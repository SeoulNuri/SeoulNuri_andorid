...
public class withcontainAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.detail_with_content, parent, false);

        }
        TextView subtitle = (TextView)convertView.findViewById(R.id.tv_with_subt);
        TextView infos = (TextView)convertView.findViewById(R.id.tv_with_infos);
